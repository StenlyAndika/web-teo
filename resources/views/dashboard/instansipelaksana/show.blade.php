<!-- Main modal -->
<div id="popup-edit-{{ $item->id_instansi_pelaksana }}" tabindex="-1" aria-hidden="true"
...
<div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
    ...
    <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
        ...
        <!-- Modal body -->
        <form method="post" action="{{ route('admin.instansipelaksana.update', $item->id_instansi_pelaksana) }}" autocomplete="off">
            @method('put')
            @csrf
            <div class="flex mb-4">
                <label for="nama" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 w-40">Nama Instansi</label>
            ...
            <button data-modal-hide="popup-edit-{{ $item->id_instansi_pelaksana }}" type="button"
