...
@section('container')
    ...
    @include('dashboard.kategori.add')
            ...
            @foreach ($kategori as $item)
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="flex justify-start space-x-2">
                        <button data-modal-target="popup-edit-{{ $item->id_kategori }}"
                        ...
                        @include('dashboard.kategori.show')
                        <button data-modal-target="popup-delete-{{ $item->id_kategori }}"
                            data-modal-toggle="popup-delete-{{ $item->id_kategori }}"
                        ...
                        @include('dashboard.kategori.delete')
                    </td>
                </tr>
            @endforeach
            </tr>
