<!-- Main modal -->
<div id="popup-edit-{{ $item->id_instansi_penyidik }}" tabindex="-1" aria-hidden="true"
...
<div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
    ...
    <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
        ...
        <!-- Modal body -->
        <form method="post" action="{{ route('admin.instansipenyidik.update', $item->id_instansi_penyidik) }}" autocomplete="off">
            @method('put')
            @csrf
            <div class="flex mb-4">
            ...
            <button data-modal-hide="popup-edit-{{ $item->id_instansi_penyidik }}" type="button"
