<!-- Main modal -->
<div id="popup-edit-{{ $item->id_wilayah_pelimpahan }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="popup-edit-{{ $item->id_wilayah_pelimpahan }}">
            ...
            <!-- Modal body -->
            <form method="post" action="{{ route('admin.wilayahpelimpahan.update', $item->id_wilayah_pelimpahan) }}"
                autocomplete="off">
                @method('put')
                @csrf
                <div class="flex mb-4">
                    <label for="nama"
                        class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-300 w-50">Nama
                        Wilayah Pelimpahan</label>
                ...
                <div class="flex space-x-1 items-center pb-4 pt-4 mt-4 mb-4 rounded-t border-b border-t sm:mb-5">
                    ...
                    <button data-modal-hide="popup-edit-{{ $item->id_wilayah_pelimpahan }}" type="button"
