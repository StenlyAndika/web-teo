...
@section('container')
    ...
    @include('dashboard.wilayahpelimpahan.add')
            ...
            @foreach ($instansi as $item)
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="flex justify-start space-x-2">
                        <button data-modal-target="popup-edit-{{ $item->id_wilayah_pelimpahan }}"
                        ...
                        @include('dashboard.wilayahpelimpahan.show')
                        <button data-modal-target="popup-delete-{{ $item->id_wilayah_pelimpahan }}"
                            data-modal-toggle="popup-delete-{{ $item->id_wilayah_pelimpahan }}"
                        ...
                        @include('dashboard.wilayahpelimpahan.delete')
                    </td>
                </tr>
            @endforeach
        </tbody>
