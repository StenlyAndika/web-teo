        ...
        <form method="post" action="{{ route('admin.jaksa.store') }}" autocomplete="off">
            ...
            <div class="flex mb-4">
                ...
                <div class="relative w-full">
                    <input type="text" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500" id="nama_jaksa" name="nama_jaksa" required/>
                </div>
            </div>
            <div class="flex mb-4">
