            ...
            @foreach ($catatan as $item)
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="flex justify-start space-x-2">
                        <button data-modal-target="popup-edit-{{ $item->id_catatan }}"
                        ...
                        @include('dashboard.catatan.show')
                        <button data-modal-target="popup-delete-{{ $item->id_catatan }}"
                            data-modal-toggle="popup-delete-{{ $item->id_catatan }}"
                        ...
                        @include('dashboard.catatan.delete')
                    </td>
                </tr>
            @endforeach
            </tr>
