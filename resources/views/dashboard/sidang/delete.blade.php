    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                @endphp
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Hapus sidang dengan no perkara :
                    {{ $a->no_perkara }}?</h3>
                <form action="{{ route('admin.sidang.destroy', $item->id_sidang) }}" method="post">
                    @method('delete')
                    @csrf
                    <button type="submit"
                    ...
                    <button data-modal-hide="popup-delete-{{ $item->id_sidang }}" type="button"
