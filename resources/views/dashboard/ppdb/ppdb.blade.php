...
@section('container')
    <div class="max-w-screen-xl px-4 mx-auto lg:gap-8 xl:gap-0 lg:grid-cols-12">
            ...
            <form method="post" action="{{ route('admin.ppdb.store') }}" enctype="multipart/form-data"
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-2 text-left">
                    <div>
                        ...
                        <input type="hidden" name="id_data_siswa" value="{{ $siswa->id_data_siswa }}">
                        <input type="hidden" name="nisn" value="{{ $siswa->nisn }}">
                        <input type="text" id="nisn"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="0028059453" value="{{ $siswa->nisn }}" readonly />
                    </div>
                    <div>
                ...
                <div class="grid gap-6 mb-4 md:grid-cols-2 text-left">
                    <div>
                        ...
                        <input type="text" id="nama" name="nama"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                            placeholder="Budi Rajin Menabung" value="{{ $siswa->nama }}" required />
                    </div>
                    <div>
