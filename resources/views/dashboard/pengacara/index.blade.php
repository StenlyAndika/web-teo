...
@section('container')
    ...
    @include('dashboard.pengacara.add')
            ...
            @foreach ($kategori as $item)
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="flex justify-start space-x-2">
                        <button data-modal-target="popup-edit-{{ $item->id_pengacara }}"
                        ...
                        @include('dashboard.pengacara.show')
                        <button data-modal-target="popup-delete-{{ $item->id_pengacara }}"
                            data-modal-toggle="popup-delete-{{ $item->id_pengacara }}"
                        ...
                        @include('dashboard.pengacara.delete')
                    </td>
                </tr>
            @endforeach
            </tr>
