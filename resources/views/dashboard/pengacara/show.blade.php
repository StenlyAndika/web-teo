<!-- Main modal -->
<div id="popup-edit-{{ $item->id_pengacara }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
        ...
        <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5">
            ...
            <button type="button"
                ...
                data-modal-toggle="popup-edit-{{ $item->id_pengacara }}">
        ...
        <!-- Modal body -->
        <form method="post" action="{{ route('admin.pengacara.update', $item->id_pengacara) }}" autocomplete="off">
            @method('put')
            @csrf
            <div class="flex mb-4">
                ...
                <div class="relative w-full">
                    <input type="text" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500" id="nama_pengacara" name="nama_pengacara" value="{{ $item->nama_pengacara }}" required/>
                </div>
            </div>
            <div class="flex mb-4">
            ...
            <div class="flex mb-4">
                ...
                <div class="relative w-full">
                    <input type="text" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg rounded-s-gray-100 rounded-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500" id="alamat" name="alamat" value="{{ $item->alamat }}" required/>
                </div>
            </div>
            <div class="flex mb-4">
            ...
            <button data-modal-hide="popup-edit-{{ $item->id_pengacara }}" type="button"
