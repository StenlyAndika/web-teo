            ...
            @foreach ($kategori as $item)
                <tr class="odd:bg-white even:bg-gray-50 border-b">
                    ...
                    <td class="flex justify-start space-x-2">
                        <button data-modal-target="popup-edit-{{ $item->id_hakim }}"
                        ...
                        @include('dashboard.hakim.show')
                        <button data-modal-target="popup-delete-{{ $item->id_hakim }}"
                            data-modal-toggle="popup-delete-{{ $item->id_hakim }}"
                        ...
                        @include('dashboard.hakim.delete')
                    </td>
                </tr>
            @endforeach
            </tr>
