...
use App\Http\Controllers\BeritaAcaraPelimpahanController;
...
Route::middleware(['admin'])->group(function () {
    ...
    Route::get('/admin/prapen/penbt1/pbp', [PenerimaanBerkasTIController::class, 'index'])->name('admin.penbt1.index');
    Route::get('/admin/prapen/penbt1/pbp/create', [PenerimaanBerkasTIController::class, 'create'])->name('admin.penbt1.create');
    ...
    Route::post('/admin/prapen/penbt1/pbp', [PenerimaanBerkasTIController::class, 'store'])->name('admin.penbt1.store');
    Route::delete('/admin/prapen/penbt1/pbp/{id}', [PenerimaanBerkasTIController::class, 'destroy'])->name('admin.penbt1.destroy');

    Route::get('/admin/prapen/penbt1/beritaacara', [BeritaAcaraPelimpahanController::class, 'index'])->name('admin.beritaacara.index');
    Route::get('/admin/prapen/penbt1/beritaacara/create', [BeritaAcaraPelimpahanController::class, 'create'])->name('admin.beritaacara.create');
    Route::get('/data-spdp/{index}', [BeritaAcaraPelimpahanController::class, 'data_spdp'])->name('data_spdp_beritaacara');
    Route::post('/admin/prapen/penbt1/beritaacara', [BeritaAcaraPelimpahanController::class, 'store'])->name('admin.beritaacara.store');
    Route::delete('/admin/prapen/penbt1/beritaacara/{id}', [BeritaAcaraPelimpahanController::class, 'destroy'])->name('admin.beritaacara.destroy');
    ...
    Route::get('/admin/laporan/p31', [LaporanController::class, 'laporan_p31'])->name('admin.laporan.p31');
